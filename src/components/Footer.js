...
const Footer = () => {
    return (
        <div className="bg-blue-600 text-white">
            <div>
                <a href="#home"><svg className="text-white" xmlns="http://www.w3.org/2000/svg" width="150" height="32" viewBox="0 0 150 32">
