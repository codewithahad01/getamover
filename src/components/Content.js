...
const Content = () => {
    return (
        <section className="relative ml-20">
            <div className="container flex flex-col-reverse lg:flex-row items-center gap-2 mt-14 lg:mt-28 ">
                ...
                <div className="bg-green-200 py-8 px-14 m-10 ">
                    <form action="#">
                    ...
                    <ol className="text-lg grid grid-cols-1 mx-40">
