...
const Card = () => {
    return (
        <div className="mt-15 text-md p-24 text-center">
        <div className="px-40 ">
            ...
            <div className="flex justify-center">
                <div className="flex flex-col justify-center max-w-xs bg-white shadow-xl p-10 pt-15 px-20 m-20">
                    <h1 className="font-bold leading-loose ">"Great Service"</h1>
                    <p className="font-mono">Kyle, 21 hours ago</p>
                    <p className="">lerom ipsum is the free<be /> and open source text and<be /> you can use them every</p>
                    <div className="flex items-start"><a href="#new">
